 ...
 * @memberOf [Virtual DOM]
*/
export function h<tag extends keyof JSX.ValidHTMLElements>(
  tag: tag,
  data?: JSX.ValidHTMLElements[tag],
  children?: (
    | VirtualNodeChild<{} | null>[]
    | VirtualNodeChild<{} | null>[][]
    | string)[]
): VirtualNode<JSX.ValidHTMLElements[tag]>
...
export function h(
  tag: string,
  data?: JSX.HTMLAttributes & JSX.SVGAttributes & { [propName: string]: any },
  children?: (
    | VirtualNodeChild<{} | null>[]
    | VirtualNodeChild<{} | null>[][]
    | string)[]
): VirtualNode<
  JSX.HTMLAttributes & JSX.SVGAttributes & { [propName: string]: any }
>
...
export interface Action<State> {
  (state: State, action: Actions<State>, data: any): ActionsResult<State>
}

export interface Actions<State> {
  [action: string]: Actions<State> | Action<State>
}
...
export interface Emit<Data, Events> {
  ...
  */
  (name: keyof Events, data?: Data): Data | any
}
...
declare global {
  namespace JSX {
    ...
    interface IntrinsicElements extends ValidHTMLElements {
      [tag: string]: any
    }
  }
}
